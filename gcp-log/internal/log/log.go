// TODO(jayhou): this is the same thing as the github except that we need the context.Context in the Storage methods.
// Maybe change the interface to include an optional context.
